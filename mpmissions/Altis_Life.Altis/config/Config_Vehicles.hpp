class CarShops {
    ...
    */
	...
	class sek_car {
        ...
        conditions = "";
        vehicles[] = {
			{ "I_MRAP_03_F", "call life_seklevel >= 2" },
			{ "C_SUV_01_F","call life_seklevel >= 1" }
        };
    };
	...
	class sek_air {
        ...
        conditions = "";
        vehicles[] = {
            { "B_Heli_Light_01_F", "call life_seklevel >= 2" }
        };
    };
...
*/
    ...
    class B_Heli_Light_01_F {
        vItemSpace = 90;
        conditions = "license_civ_pilot || {license_cop_cAir} || {license_med_mAir} || {license_adac_adacAir}";
        price = 245000;
        textures[] = {
            { "Police", "cop", {
	...
	class C_Offroad_01_repair_F {
		 vItemSpace = 65;
		 conditions = "license_adac_adacCar";
		 insurance = 2500;
		 chopShop = 6250;
		 price = 12500;
		 textures[] = {
	...
	class I_Heli_light_03_unarmed_F {
		vItemSpace = 210;
		conditions = "license_adac_adacAir";
		insurance = 2500;
		chopShop = 375000;
		textures[] = {
			{ "ADAC", "adac", {
