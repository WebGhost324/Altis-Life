...
class Clothing {
	...
	class adac_clothing {
	 ...
	 side = "adac";
	 uniforms[] = {
		 { "NONE", "Uniform entfernen", 0, "" },
		 { "U_B_HeliPilotCoveralls", "ADAC Uniform", 50, "" },
		 { "U_Rangemaster", "ADAC Uniform 2", 50, "" }
		};
	 headgear[] = {
	 ...
	 backpacks[] = {
		...
		{ "B_Kitbag_cbr", "ADAC Rucksack", 3000, "" }
		};
	};
	...
	class sek {
       ...
       condition = "";
        side = "cop";
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, "call life_seklevel >= 1"  },
            { "U_Rangemaster", "Cop Uniform", 25, "call life_seklevel >= 1" },
            { "U_B_CombatUniform_mcam_tshirt", "", 350, "call life_seklevel >= 1" },
            { "U_B_CombatUniform_mcam_worn", "", 550, "call life_seklevel >= 1" },
			{ "U_B_CombatUniform_mcam", "", 550, "call life_seklevel >= 1" },
            { "U_B_survival_uniform", "", 1250, "call life_seklevel == 4" }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, "call life_seklevel >= 1"  },
            { "H_Cap_police", "", 25, "call life_seklevel >= 1"  },
            { "H_Beret_blk_POLICE", "", 50, "call life_seklevel >= 1" },
            { "H_HelmetB_plain_mcamo", "", 75, "call life_seklevel >= 1" },
            { "H_MilCap_mcamo", "", 100, "call life_seklevel >= 1" },
            { "H_Booniehat_mcamo", "", 120, "call life_seklevel >= 1" }
        };
        goggles[] = {
            { "NONE", "Remove Glasses", 0, "" },
            { "G_Squares", "", 10, "" },
        ...
        vests[] = {
            { "NONE", "Remove Vest", 0, "" },
            { "V_Rangemaster_belt", "", 800, "call life_seklevel >= 1"  },
            { "V_TacVest_blk_POLICE", "", 1000, "call life_seklevel >= 1" },
            { "V_PlateCarrier2_rgr", "", 1500, "call life_seklevel >= 1" }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, "call life_seklevel >= 1"  },
            { "B_FieldPack_cbr", "", 500, "call life_seklevel >= 1"  },
            { "B_AssaultPack_cbr", "", 700, "call life_seklevel >= 1"  },
            { "B_Kitbag_cbr", "", 800, "call life_seklevel >= 1"  },
            { "B_Bergen_sgg", "", 2500, "call life_seklevel >= 1"  },
			{ "B_Bergen_blk", "", 2500, "call life_seklevel >= 1"  },
            { "B_Carryall_cbr", "", 3500, "call life_seklevel >= 1"  }
        };
    };
