...
class Clothing {
	...
	class adac_clothing {
	 ...
	 uniforms[] = {
		 ...
		 { "U_Rangemaster", "ADAC Uniform 2", 50, { "", "", -1 } }
		};
	 headgear[] = {
    ...
    class sek {
        ...
        side = "cop";
        uniforms[] = {
            { "NONE", "Remove Uniform", 0, { "life_seklevel", "SCALAR", 1 }  },
            { "U_Rangemaster", "Cop Uniform", 25, { "life_seklevel", "SCALAR", 1 } },
            { "U_B_CombatUniform_mcam_tshirt", "", 350, { "life_seklevel", "SCALAR", 1 } },
            { "U_B_CombatUniform_mcam_worn", "", 550, { "life_seklevel", "SCALAR", 1 } },
			{ "U_B_CombatUniform_mcam", "", 550, { "life_seklevel", "SCALAR", 1 } },
            { "U_B_survival_uniform", "", 1250, { "life_seklevel", "EQUAL", 4 } }
        };
        headgear[] = {
            { "NONE", "Remove Hat", 0, { "life_seklevel", "SCALAR", 1 }  },
            { "H_Cap_police", "", 25, { "life_seklevel", "SCALAR", 1 }  },
            { "H_Beret_blk_POLICE", "", 50, { "life_seklevel", "SCALAR", 1 } },
            { "H_HelmetB_plain_mcamo", "", 75, { "life_seklevel", "SCALAR", 1 } },
            { "H_MilCap_mcamo", "", 100, { "life_seklevel", "SCALAR", 1 } },
            { "H_Booniehat_mcamo", "", 120, { "life_seklevel", "SCALAR", 1 } }
        };
        goggles[] = {
            { "NONE", "Remove Glasses", 0, { "", "", -1 } },
            { "G_Squares", "", 10, { "", "", -1 } },
        ...
        vests[] = {
            { "NONE", "Remove Vest", 0, { "", "", -1 } },
            { "V_Rangemaster_belt", "", 800, { "life_seklevel", "SCALAR", 1 }  },
            { "V_TacVest_blk_POLICE", "", 1000, { "life_seklevel", "SCALAR", 1 } },
            { "V_PlateCarrier2_rgr", "", 1500, { "life_seklevel", "SCALAR", 1 } }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, { "life_seklevel", "SCALAR", 1 }  },
            { "B_FieldPack_cbr", "", 500, { "life_seklevel", "SCALAR", 1 }  },
            { "B_AssaultPack_cbr", "", 700, { "life_seklevel", "SCALAR", 1 }  },
            { "B_Kitbag_cbr", "", 800, { "life_seklevel", "SCALAR", 1 }  },
            { "B_Bergen_sgg", "", 2500, { "life_seklevel", "SCALAR", 1 }  },
			{ "B_Bergen_blk", "", 2500, { "life_seklevel", "SCALAR", 1 }  },
            { "B_Carryall_cbr", "", 3500, { "life_seklevel", "SCALAR", 1 }  }
        };
    };
    ...
    class med_clothing {
        ...
        backpacks[] = {
			...
			{ "B_TacticalPack_blk", "EMS Backpack", 3000, { "", "", -1 } }
        };
    };
