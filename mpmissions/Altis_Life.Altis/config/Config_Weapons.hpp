...
class WeaponShops {
    ...
    class sek {
        ...
        items[] = {
            ...
            { "FirstAidKit", "", 150, 65, { "", "", -1 } },
            { "NVGoggles", "", 2000, 980, { "", "", -1 } },
            { "HandGrenade_Stone", "Flashbang", 1700, -1, {"life_seklevel", "SCALAR", 2 } },
            { "SMG_02_ACO_F", "", 30000, -1, {"life_seklevel", "SCALAR", 2 } },
            { "arifle_MX_F", "", 35000, 7500, {"life_seklevel", "SCALAR", 2 } },
            { "hgun_ACPC2_F", "", 17500, -1, {"life_seklevel", "SCALAR", 3 } },
            { "arifle_MXC_F", "", 30000, 5000, {"life_seklevel", "SCALAR", 3 } }
        };
        mags[] = {
            { "30Rnd_65x39_caseless_mag", "", 130, 100, { "life_seklevel", "SCALAR", 2 } },
            { "30Rnd_9x21_Mag", "", 250, 100, {"life_seklevel", "SCALAR", 2 } },
            { "9Rnd_45ACP_Mag", "", 200, 100, {"life_seklevel", "SCALAR", 3 } }
        };
        accs[] = {
            { "muzzle_snds_L", "", 650, 100, { "", "", -1 } },
            { "acc_flashlight", "", 750, 100, {"life_seklevel", "SCALAR", 2 } },
            { "optic_Holosight", "", 1200, 100, {"life_seklevel", "SCALAR", 2 } },
            { "optic_Arco", "", 2500, 100, {"life_seklevel", "SCALAR", 2 } },
            { "muzzle_snds_H", "", 2750, 100, {"life_seklevel", "SCALAR", 2 } },
            { "optic_MRD", "", 2750, 100, {"life_seklevel", "SCALAR", 2 } }
        };
    };
