...
class WeaponShops {
    ...
    class sek {
        ...
        items[] = {
            ...
            { "FirstAidKit", "", 150, 65, "" },
            { "NVGoggles", "", 2000, 980, "" },
            { "HandGrenade_Stone", "Flashbang", 1700, -1, "call life_seklevel >= 2" },
            { "SMG_02_ACO_F", "", 30000, -1, "call life_seklevel >= 2" },
            { "arifle_MX_F", "", 35000, 7500, "call life_seklevel >= 2" },
            { "hgun_ACPC2_F", "", 17500, -1, "call life_seklevel >= 3" },
            { "arifle_MXC_F", "", 30000, 5000, "call life_seklevel >= 3" }
        };
        mags[] = {
            { "30Rnd_65x39_caseless_mag", "", 130, 100, "call life_seklevel >= 2" },
            { "30Rnd_9x21_Mag", "", 250, 100, "call life_seklevel >= 2" },
            { "9Rnd_45ACP_Mag", "", 200, 100, "call life_seklevel >= 3" }
        };
        accs[] = {
            { "muzzle_snds_L", "", 650, 100, "" },
            { "acc_flashlight", "", 750, 100, "call life_seklevel >= 2" },
            { "optic_Holosight", "", 1200, 100, "call life_seklevel >= 2" },
            { "optic_Arco", "", 2500, 100, "call life_seklevel >= 2" },
            { "muzzle_snds_H", "", 2750, 100, "call life_seklevel >= 2" },
            { "optic_MRD", "", 2750, 100, "call life_seklevel >= 2" }
        };
    };
